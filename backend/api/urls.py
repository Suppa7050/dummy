...
from .views import JobListCreateView, JobDetailView, ApplicationCreateView, AnswerCreateView, ApplicationListByJobView, apply_for_job,UpdateApplicationStatusView
from . import views
urlpatterns = [
